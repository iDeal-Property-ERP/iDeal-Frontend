...
/**
 * Legacy route — Bookings were merged into the unified Leads triage queue
 ...
 */
export default async function BookingsRedirect(props: { params: Promise<{ locale: string }> }) {
